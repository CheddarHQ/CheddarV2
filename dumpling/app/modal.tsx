...
export default function Modal() {
  ...
  const ids = "GGXDG9XzfazWZGyV6CPKHQyB1V6qDzXGYb5RyufqfTVN,zcdAw3jpcqEY8JYVxNVMqs2cU35cyDdy4ot7V8edNhz,34Vzjmat2bRAY3mTxXaCemnT1ca51Tj7xL3J9T1cHhiT,3a7fVXt9vpQbxytdDkqep2n5hqw8iyCdXuN3N4i6Ki3r";
  ...
  return (
    <YStack
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        ...
        {tokenData && tokenData.basicInfo && tokenData.basicInfo.map((item, index) => (
          <Pressable
            key={index}
            onPress={() => {
            ...
            <Card elevate paddingVertical={20} borderRadius={0} backgroundColor="#000000">
              <XStack alignItems="center" space>
                ...
                <Text style={{ fontSize: 14, color: item.priceChange >= 0 ? '#00FF00' : '#FF0000' }}>
